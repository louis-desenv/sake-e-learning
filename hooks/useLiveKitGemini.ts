        ...
        callbacks: {
          ...
          onmessage: async (message: LiveServerMessage) => {
            ...
            if (message.serverContent?.inputTranscription) {
              setUserTranscript(prev => concatTranscripts(prev, message.serverContent!.inputTranscription!.text));
            }
            // AI transcription (what Gemini said)
            if (message.serverContent?.outputTranscription) {
              setIsAwaitingResponse(false);
              setAiTranscript(prev => concatTranscripts(prev, message.serverContent!.outputTranscription!.text));
            }
