...
const ConnectingSpinner = () => (
  <div className="flex flex-col items-center justify-center space-y-6">
    ...
    <div className="text-center">
      ...
      <p className="text-white/50 text-sm mt-3">Preparing your session...</p>
    </div>
      ...
      {isConnected && participants.length > 0 && (
        <div className="absolute top-4 right-4 flex space-x-2 z-30 animate-fade-in">
          {participants.slice(0, 4).map((p, i) => (
            <div
              key={i}
              className="w-9 h-9 rounded-full bg-white/90 flex items-center justify-center text-xs font-bold shadow-lg"
            >
        ...
        {!isConnected && (
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="relative bg-gray-700 rounded-2xl px-6 py-3 shadow-2xl">
              <p className="text-white text-base font-medium">Tap to start conversation</p>
