...
const Login: React.FC<LoginProps> = ({ onLoginComplete }) => {
  ...
  const handleEmailLogin = (e: React.FormEvent) => {
    e.preventDefault();
    // Simulation: create dummy profile
  ...
  const handleGmailLogin = () => {
    ...
    const dummyProfile: UserProfile = {
      ...
      interests: 'Travel and culture',
      nativeLanguage: 'Spanish' as any,
    };
    onLoginComplete(dummyProfile);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-400 via-purple-500 to-pink-500 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-8 space-y-6">
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3 rounded-xl font-semibold hover:from-blue-600 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
          >
