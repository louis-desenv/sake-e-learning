...
import { UserLearningProfile } from './profileService';
...
export function determineLearningFocus(profile: UserLearningProfile | null): LearningFocus {
  ...
  return {
    ...
    priorityTopics: areasToImprove.slice(0, 5),
    commonPitfalls,
    correctionStyle: 'explanatory',
  };
}
...
export function buildRAGPrompt(
  ...
  if (learningFocus.priorityTopics.length > 0) {
    sections.push(
  ...
  sections.push(
    ...
    userMessage,
    '',
    'Responda de forma personalizada, considerando o perfil e histórico do aluno.'
  );
